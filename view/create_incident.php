...
function head_extra()
{
    ...
    <style type="text/css">
        ...
        #create-inc-table .row-separator {
            height: 13px;
            width: 0;
        }
        #create-inc-table .col-separator {
            height: 0;
            width: 8px;
        }
        #create-inc-table td {
...
function body_extra()
{
    ...
    <div id="main-cont-div">
        ...
        <br/>
        <div id="create-inc-div">
            <form id="create-inc-form" action="index.php?route=create_incident" method="POST" >
                <table id="create-inc-table">
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="col-separator"></td>
                        <td>
                            <div id="inc-agency-div">
                                <label class="noselect">
                                    <input type="checkbox" name="inc_agency[]" value="Ambulance">
                                    Emergency Ambulance - SingaporeCivil Defence Force (SCDF)
                                </label>
                                <br/>
                                <label class="noselect">
                                    <input type="checkbox" name="inc_agency[]" value="Evacuation">
                                    Rescue and Evacuation - SCDF
                                </label>
                                <br/>
                                <label>
                                    <input type="checkbox" name="inc_agency[]" value="FireFighting">
                                    Fire-Fighting - SCDF
                                </label>
                            </div>
                        </td>
